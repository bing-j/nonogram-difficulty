...
- Puzzle 2: adjusted difficulty = 2.568
- Puzzle 5: adjusted difficulty = 3.402
- Puzzle 1: adjusted difficulty = 3.484
- Puzzle 4: adjusted difficulty = 3.491
- Puzzle 0: adjusted difficulty = 3.522
- Puzzle 3: adjusted difficulty = 4.011

The strongest Spearman correlation between adjusted difficulty and SAT statistics was for `decisions`, rho = 0.257. The largest change from the raw `mean_final_rating` Spearman result was for `decisions`, changing by 0.141.
