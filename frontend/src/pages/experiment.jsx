...
export default function Home() {
  ...
  usePreventAccidentalExit(Boolean(sessionId) && stage !== STAGES.COMPLETED);
  ...
  const handlePostPuzzleSurveySubmit = async (answers) => {
    ...
    if (puzzleIndex === 2) {
      ...
      setHintsRemaining(nextPuzzleData.hints_remaining ?? 0);
      setHintsUsed(0);
      ...
      if (nextIndex >= 3) {
        ...
        try {
          ...
          if (res.completed) {
            ...
            setHintsRemaining(res.hints_remaining ?? 0);
            setHintsUsed(0);
